    ...
    <Header />
        ...
        <div className='newHaven'>
          <img id='newHaven' src='http://i49.tinypic.com/2rz5746.jpg' height='300' width='300' />
           <p className='homeA'> Born and raised in New Haven Connecticut, home to Yale University and known as the "Cultural Capital of Connecticut". I always been exposed to the arts when growing up. During my childhood, I was always either in photography, video, dance, drawing, painting, choir or theatre. </p>
         </div>
         <div className='coop'>
         ...
         <div className='step'>
           ...
           <iframe id='step' width='560' height='315' src='https://www.youtube.com/embed/sW8PQT-uhbw' frameBorder='0' allowFullScreen></iframe>
         </div>
         <div className='sauls'>
